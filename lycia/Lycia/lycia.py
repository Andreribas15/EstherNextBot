...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Eliza", "@Esthernextbot")
        result = result.replace("Hi~", "Hello Friend I Am @Esthernextbot")
        result = result.replace("My dear great botmaster, Estherbot Team.", "Made By @Andre_Ribas")
        result = result.replace("Have the control right.", "My Father Is @Andre_Ribas")
        result = result.replace("I was created by Estherbot Team.", "I was created by @Andre_Ribas Team.")
...
async def redaura(client, message):
    ...
    result = result.replace("Eliza", "@Esthernextbot")
    result = result.replace("Hi~", "Hello Friend I Am @Esthernextbot")
    result = result.replace("My dear great botmaster, Daisybot Team.", "Made By @Andre_Ribas")
    result = result.replace("Have the control right.", "My Father Is @Andre_Ribas")
    result = result.replace("I was created by Estherbot Team.", "I was created by @Andre_Ribas Team.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")
